  ...
  <div class="p-4 max-w-5xl space-y-6 min-h-screen">
    <div class="flex items-center gap-3">
        <div class="bg-red-200 rounded-full p-2">
          <i class="fas fa-chart-bar text-xl text-red-700"></i>
        </div>
    ...
    <!-- <div class="flex items-center gap-3 mb-6">
      <div class="bg-red-100 rounded-full p-3 flex items-center justify-center">
        <i class="fas fa-chart-bar text-2xl text-red-700"></i>
      </div>
      <h1 class="text-3xl font-bold text-red-700 tracking-tight">Reports Dashboard</h1>
    </div> -->

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Inventory & Stock -->
      <section class="rounded-2xl border border-red-100 shadow-lg overflow-hidden bg-white">
        <div class="px-4 py-3 bg-red-50 font-semibold flex items-center gap-2 text-red-900 text-sm">
          <i class="fas fa-cubes text-red-500 text-xl"></i>
          Inventory & Stock
        </div>
        <div class="p-3 space-y-2">
          <router-link
            ...
            class="w-full px-4 py-3 rounded-xl border border-red-100 bg-white hover:bg-red-50 text-left shadow-sm transition flex items-center gap-3"
          >
            <i class="fas fa-box-open text-red-400 text-lg"></i>
            <div>
              <div class="font-semibold text-red-700">{{ it.title }}</div>
            </div>
          </router-link>
        </div>
      </section>
      ...
      <section class="rounded-2xl border border-red-100 shadow-lg overflow-hidden bg-white">
        ...
        <div class="p-3 space-y-2">
          <router-link
            ...
            class="w-full px-4 py-3 rounded-xl border border-red-100 bg-white hover:bg-red-50 text-left shadow-sm transition flex items-center gap-3"
          >
            <i class="fas fa-user-tie text-red-400 text-lg"></i>
            <div>
              <div class="font-semibold text-red-700">{{ it.title }}</div>
            </div>
          </router-link>
      ...
      <section class="rounded-2xl border border-red-100 shadow-lg overflow-hidden bg-white">
        ...
        <div class="p-3 space-y-2">
          <router-link
            ...
            class="w-full px-4 py-3 rounded-xl border border-red-100 bg-white hover:bg-red-50 text-left shadow-sm transition flex items-center gap-3"
          >
            <i class="fas fa-chart-pie text-red-400 text-lg"></i>
            <div>
              <div class="font-semibold text-red-700">{{ it.title }}</div>
            </div>
          </router-link>
