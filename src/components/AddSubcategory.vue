  ...
  <div v-if="open" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
    <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
      <div class="flex items-center mb-4">
        ...
        <h2 class="text-lg font-bold text-teal-700">Add New Subcategory</h2>
      ...
      <form @submit.prevent="submit">
        <div class="mb-4">
          <label class="block text-xs font-semibold text-teal-700 mb-1">Category</label>
          <select v-model="selectedCategory" class="w-full border border-teal-200 rounded px-3 py-2 text-xs" required>
        ...
        <div class="mb-4">
          ...
          <input v-model="subcategoryName" type="text" class="w-full border border-teal-200 rounded px-3 py-2 text-xs" required />
        </div>
